...
public partial class WalkController : BasePlayerController
{
	...
	public virtual void WalkMove()
	{
		...
		//   BBPlayer.SetAnimParam( "forward", Input.Forward );
		//   BBPlayer.SetAnimParam( "sideward", Input.Right );
		//   BBPlayer.SetAnimParam( "wishspeed", wishspeed );
		//    BBPlayer.SetAnimParam( "walkspeed_scale", 2.0f / 190.0f );
		//   BBPlayer.SetAnimParam( "runspeed_scale", 2.0f / 320.0f );
